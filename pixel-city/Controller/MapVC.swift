...
class MapVC: UIViewController, UIGestureRecognizerDelegate {
    ...
    func retriveUrls(forAnnotation annotation: DroppablePin, handler: @escaping (_ status: Bool) -> ()) {
        ...
        Alamofire.request(flickrUrl(forApiKey: apiKey, withAnnotation: annotation, andNumerOfPhotos: 40)).responseJSON { (response) in
    ...
    func cancelAllSessions() {
        Alamofire.SessionManager.default.session.getTasksWithCompletionHandler { (sessionDataTask, updaloadData, downloadData) in
